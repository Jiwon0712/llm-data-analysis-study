...
| 계산 범위 |전월 대비 매출 증감을 계산한 결과, 6월부터 9월까지 연속 하락이 확인됨. 이를 근거로 "연속 하락 시작 전(2025-09~2026-05, 9개월)"과 "연속 하락 구간(2026-06~2026-09, 4개월)"으로 나누고, 기간 길이가 다르므로 월평균 매출로 정규화하여 카테고리별 비교 |
...
계산 범위를 6월 이전(1~5월)과 이후(6~9월) 두 구간이 아니라, 전월 대비 매출 증감을 계산하여 6~9월까지 연속 하락이 확인되었으므로 연속 하락 시작 전(2025-09~2026-05)과 연속 하락 구간(2026-06~2026-09)으로 나누는 것으로 수정하였음.
```
